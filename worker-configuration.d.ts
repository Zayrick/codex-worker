/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d2ebf9a64aec9ed8ec3c4d559d76c6d)
// Runtime types generated with workerd@1.20260730.1 2026-07-29 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	AUTH_KV: KVNamespace;
	CORS_ORIGIN: "*";
	CODEX_RELAY_URL: string;
	DEVICE_AUTH_SECRET: string;
	OAUTH_MASTER_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "CODEX_RELAY_URL" | "DEVICE_AUTH_SECRET" | "OAUTH_MASTER_KEY">> {}
}
